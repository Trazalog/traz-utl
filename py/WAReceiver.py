...
SERVER="10.142.0.11:8283"
API_URL = f"http://{SERVER}"
IMAGE_SAVE_DIRECTORY = '/var/www/html/tools/traz-prod-assetplanner/assets/images'
pattern = r'^TTOOLS-SOLSERV-(\d+)$'
account_sid = 'ACf37511c7d00c8af84a1558005f99a5e7'
auth_token = '168f5aeb0716648418df31c608a33354'
...
def obtener_datos_usuario(from_number):
    try:
        ...
        user_url = f"{API_URL}/services/COREDataService/usuario/porTelefono/{wha}"
...
def webhook():
    try:        
        ...
        if step == 0:
            ...
            match = re.match(pattern, incoming_msg)
            ...
            try:
                ...
                if issue_response.status_code == 200:
                    ...
                    resp.message(f"Su solicitud de servicio número *{issue_id}* fue creada exitósament👷🏽‍♂️👷🏽‍♂️👷🏽‍♂️\n "+
...
if __name__ == '__main__':
    app.run(host='0.0.0.0',debug=True,port=3651)
